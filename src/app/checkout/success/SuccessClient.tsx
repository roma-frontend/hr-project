...
export default function SuccessClient() {
  ...
  if (verified === null && sessionId) {
    return (
      ...
      >
        <p className="text-white/50">{t('checkout.success.verifying')}</p>
      </div>
    );
  }
    ...
    return (
      ...
      >
        <div className="text-center">
          <h1 className="text-3xl font-bold text-red-400 mb-4">{t('checkout.success.invalidSession')}</h1>
          <p className="text-white/50 mb-6">{t('checkout.success.invalidSessionDesc')}</p>

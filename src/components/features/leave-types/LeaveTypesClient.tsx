...
export default function LeaveTypesClient({ initialLanguage = 'en' }: { initialLanguage?: string }) {
  // SSR in the visitor's language (see PricingClient) — the navbar and every
  // heading on this page used to render English first and swap on hydration.
  const { t } = useLandingTranslation(initialLanguage);
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex flex-col items-center max-w-6xl mx-auto px-3 md:px-12 pt-20 md:pt-28 pb-12">
        ...
        <FeatureDetail type={activeTab} initialLanguage={initialLanguage} />
